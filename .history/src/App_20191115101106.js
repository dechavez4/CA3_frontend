...
const Profil = () => (
  <div>
    <h1>{facade.getInfo().username}</h1>
    {console.log(facade.getInfo())}
    <p>{facade.getInfo().issuer}</p>
    <p>{facade.getInfo().roles}</p>
    <p>{facade.getInfo().username}</p>
  </div>
)
...
const Header = (props) => {
  if (facade.getRole() === "admin") {
    ...
    <NavLink activeclassname="active" to="/Profil">{facade.getInfo().username}</NavLink>
        </li>
        <li style={{ float: "right" }}>
  ...
  return (
    <ul className="header">
      ...
      <li style={{float: "right"}}>
        <NavLink className="active" to="/Profil">{facade.getInfo().username}</NavLink>
      </li>
      <li style={{ float: "right" }}>
          <NavLink activeclassname="active" to="/Logout">Logout</NavLink>
        </li>
